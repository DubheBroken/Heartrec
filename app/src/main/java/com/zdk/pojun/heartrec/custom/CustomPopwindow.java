package com.zdk.pojun.heartrec.custom;
...
public class CustomPopwindow extends PopupWindow {
    ...
    private void initView(final Activity context,View.OnClickListener itemsOnClick) {
        ...
        this.setContentView(mView);//设置SelectPicPopupWindow的View
        this.setWidth(LayoutParams.WRAP_CONTENT);//设置SelectPicPopupWindow弹出窗体的宽
        ...
        this.setOutsideTouchable(true);//设置非PopupWindow区域是否可触摸
